...
public class LogIn {
    ...
    public static void main(String[] args) {
        ...
        if (u.equals("Cydeo") && p.equals("Cydeo123")){
            ...
            int attempts = 3;
            while (!(u.equals("Cydeo") && p.equals("Cydeo123")) && attempts>0){ //  while the credentials are invalid, and user has attempts to re-enter
                if (attempts==1){
                    System.out.println("THIS IS YOUR LAST CHANCE");
                }

                System.out.println("Incorrect username or passwordi please re-enter");
                System.out.println("Enter your username:");
                u = scan.next();
