...
public class ListOfMapPractice1 {
    public static void main(String[] args) {
        ...
        System.out.println("Name of the Scrum Masters: ");

        for (Map<String, String> eachTeam : scrumTeams) {
            for (Map.Entry<String, String> eachMember : eachTeam.entrySet()) {
                if (eachMember.getValue().equalsIgnoreCase("sm")){
                    System.out.println(eachMember.getKey());
                }
        ...
        System.out.println("Name of the Developers: ");
        for (Map<String, String> eachTeam : scrumTeams) {
            for (Map.Entry<String, String> eachMember : eachTeam.entrySet()) {
                if (eachMember.getValue().equalsIgnoreCase("developer")){
