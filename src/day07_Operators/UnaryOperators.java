...
public class UnaryOperators {
    ...
    public static void main(String[] args) {
        ...
        int a = 5;
        ++a; // pre increment : increasing the value by 1 right away
        ...
        System.out.println(++b); // pre increment : increasing the value by 1 right away
        ...
        System.out.println(++z); // pre increment , result is : 46
        System.out.println(z++); // post increment result is : 46
        System.out.println(z); // result is : 47
